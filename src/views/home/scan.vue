  ...
  <div class="scan-container">
    ...
    <div class="scan-type">
      <div :class="['type-item', curScanType == 0 ? 'item-active': '']" @click="selectType(0)">
        <bui-image src="/image/chepai.png" class="item-img"></bui-image>
        <text class="item-text">车牌</text>
      </div>
      <div :class="['type-item', curScanType == 1 ? 'item-active': '']" @click="selectType(1)">
        <bui-image src="/image/shenfenzheng.png" class="item-img"></bui-image>
        <text class="item-text">身份证</text>
      </div>
      <div :class="['type-item', curScanType == 2 ? 'item-active': '']"@click="selectType(2)" >
        <bui-image src="/image/erweima.png" class="item-img"></bui-image>
        <text class="item-text">二维码</text>
      </div>
    </div>
